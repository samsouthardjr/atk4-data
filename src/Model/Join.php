...
abstract class Join
{
    ...
    */
     ...
     * @param mixed $value
     */
    protected function assertValueNotNull($value): void
    {
        if ($value === null) {
            throw (new Exception('Value is expected to be NOT null'))
    ...
    public function beforeUpdate(Model $entity, array &$data): void
    {
        ...
        $this->assertValueNotNull($foreignId);
